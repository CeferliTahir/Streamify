...
const InputGroup = () => {
  ...
  return (
    <>
      <div className="flex md:gap-6 sm:gap-6 gap-4 items-center w-full">
        <svg
        ...
        <input
          ...
          className="w-full bg-transparent text-white outline-none font-abc md:text-2xl sm:text-2xl text-base font-normal opacity-[0.4979]"
        />
      </div>
    </>
  );
